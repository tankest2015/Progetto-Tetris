...
bool pause(){
    ...
    while(pass){             //logica simile per il menu di gioco
        ...
        if(highlight == 0){             //il secondo parametro mi permette di far continuare il for per tot elementi dell'array
            T.menu_S(highlight,2);     //prima dovevo modificarlo solo nella libreria.
        }
        else{
