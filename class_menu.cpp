...
void Read_menu::scr(){
    ...
    mvwprintw(win_rank, 8, 1, "Position:");
    mvwprintw(win_rank, 8, 20, "Name:");
    mvwprintw(win_rank, 8, 40, "Time[hh/mm/ss]:");
    mvwprintw(win_rank, 8, 60, "Points:");
    mvwprintw(win_rank, 8, 80, "Completed rows:");
